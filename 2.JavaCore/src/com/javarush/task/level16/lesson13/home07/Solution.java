package com.javarush.task.level16.lesson13.home07;
            ...
            try {
                while (true) {
                    sleep((long) 1000 / rating);
                        if (OnlineGame.steps.size() > step) {
                            System.out.println(Thread.currentThread().getName() + ":" + OnlineGame.steps.get(step));
                        } else {
